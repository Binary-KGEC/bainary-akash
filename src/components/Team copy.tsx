...
<PageSection id="mentors">
      <div className="mt-[96px] md:mt-[116px]">
        ...
        <div className="text-white text-shadow-lg sm:hidden text-center shad index-z skew-x-6 mb-20 shadow-md bg-gradient-to-br from-green-950/40 to-green-700/40 shadow-green-700  " >Mentors</div>
