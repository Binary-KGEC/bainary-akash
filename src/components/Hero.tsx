    ...
    <PageSection className="flex flex-col justify-center ">
      <div id="hero" ref={heroTopRef} className="flex flex-col justify-center gap-8">
        <div className="w-full flex flex-col justify-center md:text-[1.5rem]">
          <motion.div  className="flex flex-col w-full items-center justify-center lg:mt-[10%] mt-[15%]"initial={{ opacity: 1, scale: 0 }}
          ...
          <h1 className="text-green-500 text-center mt-3 font-pixelate font-bold" ><TypeAnimation2 text="Binary Hackathon starts in"/></h1>
